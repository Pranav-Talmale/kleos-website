...
import { UncontrolledAlert, Container, Button, Modal } from "reactstrap";
    ...
    <div className="section section-notifications" id="FAQs">
      <Container>
        ...
        <UncontrolledAlert
          ...
          color="primary"
          onClick={() => setpartispateModal(true)}
        >
        ...
        <Modal
          isOpen={partispateModal}
          toggle={() => setpartispateModal(false)}
        >
          ...
          <div className="modal-body">
            <p>
              The hackathon is open for all undergrad students. It is the right
              place for anyone who's interested in learning and innovating with
              their ideas.
            </p>
          </div>
        ...
        <Modal isOpen={costModal} toggle={() => setcostModal(false)}>
          ...
          <div className="modal-body">
            <p>
              Although registration for KLEOS is completely free, a small
              participation fee has to be paid incase your team is shortlisted.
            </p>
          </div>
          <div className="modal-footer">
            <Button
        ...
        <Modal isOpen={applyModal} toggle={() => setapplyModal(false)}>
          ...
          <div className="modal-body">
            <p>
              Simply click the register button and mention you and your team
              details. Registrations end on 5th March 2023
            </p>
          </div>
          <div className="modal-footer">
        ...
        <Modal isOpen={round2Modal} toggle={() => setround2Modal(false)}>
          <div className="modal-header justify-content-center">
            ...
            <h4 className="title title-up">
              What if my team gets into round 2 ?
            </h4>
          </div>
          <div className="modal-body">
            <p>
              No worries, We'll be making arrangement for teams in our college
              campus. If the team wants to stay with their parents they can stay
              at their own expense. A curated list of hotels nearby college is
              here
            </p>
          </div>
          <div className="modal-footer">
            <Button
              color="default"
              type="button"
              href="https://drive.google.com/file/d/1MdUMhgkYqoQcgLdY07_6wDgQUtOJoH33/view?usp=drivesdk"
              target="blank"
            >
              Hotels List
            </Button>
        ...
        <Modal isOpen={prizesModal} toggle={() => setprizesModal(false)}>
          ...
          <div className="modal-body">
            <p>
              Total cash prize of Rs 50,000 has been announced for the winning
              teams along with it there will be additional prizes and goodies.
            </p>
          </div>
          <div className="modal-footer">
            <Button
        ...
        <Modal isOpen={teamModal} toggle={() => setteamModal(false)}>
          ...
          <div className="modal-body">
            <p>
              Yes! We believe that you’re stronger as a team than apart. You can
              form teams of 1-4 people. Most teams aim to have a mix of people
              with both design and development skills.
            </p>
          </div>
          <div className="modal-footer">
            <Button
