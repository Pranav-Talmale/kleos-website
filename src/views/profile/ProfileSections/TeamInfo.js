            ...
            <Row>
              <Col lg="6" md="6">
                ...
                <p className="profile-description">
                  Want to do a 1v4, no problems. We can also accomodate for
                  duos, trios, and squads. Its as simple as clicking the "Add
                  Member" button and adding your teammates. Don't forget to set
                  your team's name. It will be crucial during the actual
                  competition.
                  <br />
                  <br />
                  <b>
                    Choose and add your teammates carefully. You won't be able
                    to change it later !
                  </b>
                </p>
              ...
              <Col className="ml-auto mr-auto" lg="4" md="6">
                <Card className="card-coin card-plain">
                  <CardHeader>
                    ...
                    />
                    <h4 className="title">
                      {userInfo.shortTeamName === null ||
                      userInfo.shortTeamName === undefined ? (
                        <>Team Information</>
                      ) : (
                        ...
                        <Table className="tablesorter" responsive>
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td>2</td>
                              <td>
                                {userInfo.member2Name === null ||
                                userInfo.member2Name === undefined ? (
                                  <>
                                    <Button
                            ...
                            <tr>
                              <td>3</td>
                              <td>
                                {userInfo.member3Name === null ||
                                userInfo.member3Name === undefined ? (
                                  <>
                                    <Button
                                      className="btn-simple btn-round"
                                      color="primary"
                            ...
                            <tr>
                              <td>4</td>
                              <td>
                                {userInfo.member4Name === null ||
                                userInfo.member4Name === undefined ? (
                                  <>
                                    <Button
                                      className="btn-simple btn-round"
                                      color="primary"
                      ...
                      <TabPane tabId="tab3">
                        <Table className="tablesorter" responsive>
                          ...
                          <tbody>
                            <tr>
                              <td>1</td>
                              <td>{userInfo.member1Email}</td>
                            </tr>
                            <tr>
                              <td>2</td>
                              <td>
                                {userInfo.member2Email === null ||
                                userInfo.member2Email === undefined ? (
                                  <>
                                    <Button
                                      className="btn-simple btn-round"
                                      color="primary"
                            ...
                            <tr>
                              <td>3</td>
                              <td>
                                {userInfo.member3Email === null ||
                                userInfo.member3Email === undefined ? (
                                  <>
                                    <Button
                                      className="btn-simple btn-round"
                                      color="primary"
                            ...
                            <tr>
                              <td>4</td>
                              <td>
                                {userInfo.member4Email === null ||
                                userInfo.member4Email === undefined ? (
                                  <>
                                    <Button
                                      className="btn-simple btn-round"
                                      color="primary"
